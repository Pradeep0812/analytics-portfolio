...
export const metadata: Metadata = {
    title: 'Excel | Case Studies',
    description: 'Excel case studies documenting financial models, templates, and automation solutions.',
};
            ...
            <div className="container-wide">
                ...
                <div className="section-header">
                    ...
                    <nav className="flex items-center gap-2 text-sm text-surface-500 dark:text-surface-400 mb-4">
                        ...
                        <span>/</span>
                        <span className="text-surface-900 dark:text-surface-50">Excel</span>
                    </nav>

                    <div className="flex items-center gap-4 mb-2">
                        <span className="text-3xl">{categoryInfo?.icon}</span>
                        <h1>Excel Case Studies</h1>
                    </div>
                ...
                {projects.length === 0 ? (
                    <div className="panel p-12 text-center">
                        <p className="text-surface-500 dark:text-surface-400">
                            No Excel case studies published yet.
                        </p>
                    </div>
                ) : (
