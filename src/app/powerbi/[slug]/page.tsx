        ...
        <article className="section">
            <div className="container-tight">
                ...
                <nav className="flex items-center gap-2 text-sm text-surface-500 dark:text-surface-400 mb-8">
                    ...
                    <span>/</span>
                    <Link href="/powerbi" className="hover:text-accent-600 dark:hover:text-accent-400">
                        Power BI
                    </Link>
                    <span>/</span>
                ...
                <header className="mb-10 pb-8 border-b border-surface-200 dark:border-surface-700">
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                        <span className="badge badge-default">Power BI</span>
                        {project.featured && (
